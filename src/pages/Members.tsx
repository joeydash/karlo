...
const Members: React.FC = () => {
  ...
  const [copiedMemberId, setCopiedMemberId] = React.useState<string | null>(
    null
  );
            ...
            <div className="flex items-center justify-between py-3 sm:py-4 gap-3">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                {isCurrentUserAdmin && (
                  <button
                    onClick={() =>
                      navigate("/certificates", { state: { from: "/members" } })
                    }
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
                <div>
                  <h2 className="text-lg sm:text-2xl font-bold text-gray-900 dark:text-white">
                    {currentOrganization?.display_name} Members
                  </h2>
                        ...
                        {alreadyJoinedMembers.map((member) => (
                          ...
                          >
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">
                              {formatDate(
                                member.joining_date || member.created_at
                              )}
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                              <button
                                onClick={() =>
                                  handleCopyMemberId(member.user_id)
                                }
        ...
        <ConfirmationModal
          ...
          message={`Are you sure you want to remove ${
            selectedMember?.auth_fullname?.fullname || "this member"
